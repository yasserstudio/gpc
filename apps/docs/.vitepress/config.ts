...
export default defineConfig({
  ...
  themeConfig: {
    ...
    footer: {
      message: 'Made by <a href="https://yasser.studio" target="_blank"><img src="/gpc/yasser-studio-logo.svg" alt="Yasser\'s Studio" style="max-height:21px;vertical-align:sub;margin:0 4px"></a> · Released under the MIT License.',
