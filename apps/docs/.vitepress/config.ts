      ...
      const faqSchema = {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: {
              "@type": "Answer",
              text: "2,612 tests across 7 packages at 90%+ line coverage. Every write operation supports --dry-run. Semantic exit codes for CI branching.",
            },
          },
          {
            "@type": "Question",
  ...
  themeConfig: {
    ...
    socialLinks: [
      ...
      { icon: "x", link: "https://x.com/yassersstudio" },
      {
        ...
        link: "mailto:support@yasser.studio",
        ariaLabel: "Email support@yasser.studio",
      },
    ],
