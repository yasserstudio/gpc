      ...
      const faqSchema = {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: {
              "@type": "Answer",
              text: "2,630 tests across 7 packages at 90%+ line coverage. Every write operation supports --dry-run. Semantic exit codes for CI branching.",
            },
          },
          {
            "@type": "Question",
