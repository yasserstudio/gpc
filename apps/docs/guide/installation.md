...
The interactive wizard lets you select from 19 skills covering setup, releases, metadata, vitals, CI/CD, monetization, and more. See the [Agent Skills](../advanced/skills) page for the full list.
