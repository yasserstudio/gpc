...
| `gpc-release-flow`       | Upload AAB/APK, draft releases, rollouts, promote, `gpc diff`, `gpc changelog` |
...
| `gpc-monetization`       | Subscriptions, IAP, RTDN notifications, voided purchases, pricing  |
