...
vi.mock("@gpc-cli/core", () => {
  ...
  return {
    ...
    downloadStatsReport: vi.fn().mockResolvedValue({ objectName: "", csv: "" }),
    downloadFinancialReport: vi.fn().mockResolvedValue({ objectName: "", kind: "csv", text: "" }),
    resolveReportsBucket: vi.fn().mockReturnValue("pubsite_prod_1"),
