...
- Current version: v0.9.33 — pre-release series (`0.9.x` → `1.0.0` public launch)
- 1,467 total tests, 7 packages building, 90%+ line coverage on all core packages
- GitHub Releases: umbrella `v*` tags only, user-facing notes (see `apps/docs/advanced/conventions.md` for template)

## Testing

- Vitest for all tests (1,467 total across 7 packages + e2e)
