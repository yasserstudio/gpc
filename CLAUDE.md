...
- Current version: v0.9.89 — pre-release series (`0.9.x` → `1.0.0` public launch)
...
- 2,421 total tests, 7 packages building, 90%+ line coverage on all core packages
...
- Vitest for all tests (2,421 total across 7 packages + e2e)
