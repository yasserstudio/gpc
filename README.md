...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-1536_passing-00D26A?style=for-the-badge" alt="Tests">
...
| Test suite          | 1,536 tests, 90%+ coverage   | —               | —                     | —            |
...
pnpm install
pnpm build
pnpm test    # 1,536 tests across 7 packages
```
